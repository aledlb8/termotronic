...
export default function FAQ() {
  ...
  // Lista completa de preguntas con sus títulos para el buscador
  const allFAQs = [
    { key: "1", title: "¿Como funciona?" },
    { key: "3", title: "¿Por qué ahorra electricidad? Ustedes hablan de hasta un 60% de ahorro de electricidad" },
    { key: "4", title: "¿Dónde está la pérdida de calor en un calentador tradicional?" },
    { key: "5", title: "¿Me puede dar agua caliente para toda la casa o solo en un baño?" },
    { key: "2", title: "¿Cuanta presión de agua necesita?" },
    { key: "6", title: "¿A pesar de ser eléctrico es realmente seguro?" },
    { key: "7", title: "¿Este calentador puede trabajar con 110 voltios?" },
    { key: "8", title: "¿Puede abastecer a dos o tres baños a la vez?" },
    { key: "9", title: "¿A que temperatura calienta el agua? ¿Que factores pueden afectar la temperatura del agua?" },
    { key: "10", title: "¿Cuantos litros por minuto despacha este calentador?" },
    { key: "11", title: "¿Cuál es la falla más común?" },
    { key: "12", title: "¿Puedo utilizarlo para llenar una piscina?" },
    { key: "13", title: "¿Necesita ventilación?" },
    { key: "14", title: "¿Puede ir empotrado?" },
    { key: "15", title: "¿Tienen servicio a domicilio?" },
    { key: "16", title: "¿En realidad es agua caliente o solo tibia?" },
    { key: "17", title: "¿Tienen varias capacidades?" },
    { key: "18", title: "¿Puedo usarlo con tuberías de PVC?" },
    { key: "19", title: "¿Cualquier persona puede instalarlo?" },
    { key: "20", title: "¿A la hora de una falla, venden ustedes los repuestos?" },
    { key: "21", title: "Cuanto tiempo tienen en el mercado?" },
    { key: "22", title: "¿Que experiencia han tenido?" },
    { key: "23", title: "¿No es una limitación que trabaje solo con 220 voltios? ¿Por que no puedo conectarlo a 110 voltios?" },
    { key: "24", title: "¿Puedo conectar dos Termotronic en serie?" },
    { key: "25", title: "¿Que me cubre la garantía?" },
    { key: "26", title: "¿Por que sugieren en algunos casos, la instalación de un filtro de paso rápido?" },
    { key: "27", title: "¿La variación en el voltaje o picos de voltaje pueden afectar la unidad?" },
    { key: "28", title: "¿Los cortes en el suministro de agua ocasionan algún daño?" },
    { key: "29", title: "¿Es prudente bajar el breaker que alimenta el calentador si voy de viaje?" },
    { key: "30", title: "¿Puedo conectar la unidad en un circuito cerrado?" },
    { key: "31", title: "¿Por que se disparan los breaker en algunas oportunidades?" },
    { key: "32", title: "¿Cuánto tarda en llegar el agua caliente?" },
    { key: "33", title: "¿A que se refieren con instantáneo?" },
    { key: "34", title: "¿Si la distancia que hay entre el calentador y la ducha es muy grande el agua sale mas fría?" },
    { key: "35", title: "Mi calentador funciona muy bien por uno o dos minutos, entonces se apaga. ¿Qué puede ser?" },
  ];

  // Filtrar preguntas basadas en el término de búsqueda
  const filteredKeys = searchTerm.trim() === ""
    ? allFAQs.map(faq => faq.key)
    : allFAQs.filter(faq =>
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-12">
        <Input
          ...
          classNames={{
            base: "max-w-full",
            input: "text-lg",
            inputWrapper: "h-14 bg-white shadow-soft border-2 border-gray-200 hover:border-brand-300 focus-within:!border-brand-500"
          }}
          startContent={
      ...
      {filteredKeys.length === 0 && (
        <div className="text-center py-12 px-6 bg-white rounded-xl shadow-soft border-2 border-gray-200">
          <svg className="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <p className="text-xl text-gray-600 font-semibold">No se encontraron preguntas</p>
      ...
      <Accordion
        ...
        className="gap-4"
        itemClasses={{
          base: "bg-white shadow-soft hover:shadow-medium transition-all duration-300 border-2 border-gray-200 rounded-xl",
          title: "font-semibold text-lg text-gray-900",
          trigger: "px-6 py-5 hover:bg-gray-50",
          content: "px-6 pb-6 text-gray-700 leading-relaxed",
        }}>
        {filteredKeys.includes("1") && (
